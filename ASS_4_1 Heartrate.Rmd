...
par_conv_hr = optimizeParam(g7_conv_1$HR1, g7_conv_1$HR2, par, min.rec = 3.5, max.rec = 4.5)
par_conv_hr
par_turn_hr = optimizeParam(na.omit(g7_turn_1$HR1), na.omit(g7_turn_1$HR2), par, min.rec = 3.5, max.rec = 4.5)
par_turn_hr
par_sync_hr = optimizeParam(g7_sync_1$HR1, g7_sync_1$HR2, par, min.rec = 3.5, max.rec = 4.5)
par_sync_hr
